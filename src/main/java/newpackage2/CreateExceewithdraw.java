...
public class CreateExceewithdraw {

    public void mainm() {
        try {
            String filename = "c:/result.xls";
            HSSFWorkbook hwb = new HSSFWorkbook();
            HSSFSheet sheet = hwb.createSheet("Bank Withdrawal");

            HSSFRow rowhead = sheet.createRow((short) 0);
            rowhead.createCell((short) 0).setCellValue("Id");
            rowhead.createCell((short) 1).setCellValue("Branch");
            rowhead.createCell((short) 2).setCellValue("Date");
            rowhead.createCell((short) 3).setCellValue("Cheque Number");
            rowhead.createCell((short) 4).setCellValue("Withdrawal's Name");
...
//Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/test", "root", "root");
            ...
            while (rs.next()) {
                ...
                row.createCell((short) 3).setCellValue(rs.getString("chequeno"));
                row.createCell((short) 4).setCellValue(rs.getString("withdrawal"));
