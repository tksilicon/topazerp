<%-- 
    Document   : invoicepost
    Created on : Jan 17, 2015, 11:48:39 AM
    Author     : THANKGOD
--%>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header text-center">
                                <small>Post Invoice for Supply</small>
                            </h1>
                            <ol class="breadcrumb">
                                <li>
                                ...
                                <li class="active">
                                    <i class="fa fa-file"></i> Supply Invoice
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <form name="supplyForm" method="post" action="supplyinvoiceaction.jsp" method="post" onsubmit="MM_validateForm('supplypoint','','R' ); return document.MM_returnValue" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="panel panel-info">
                                    <div class="panel-body">                                        
                                        ...
                                        <div class="form-group">
                                            <input class="form-control"  type="hidden" name="supplyinvoice" value="<%= request.getParameter("suppyinvoice") %>" readonly="readonly" >
                                             
                                          
                                             <input class="form-control"  type="hidden" name="dateforsupply" value="<%= request.getParameter("dateforsupply") %>" >
                                                 
                                               
                                            
                                             <label class="control-label  col-xs-4 text-right">Branch:</label>    
                                            <div class="col-md-offset-4">
                                                <select class="form-control" name="supplypoint" >
                                                    <option value=''> Select</option>

                                                    <option value='<%= staff.getBranch()%>'> <%= staff.getBranch()%></option>
                                ...
                                <center> <button type="submit" name="supply"  class="btn btn-default" >Post for Supply</button>  </center>
