...
session.setAttribute("pageinfo2", "All Consumables");
%>
    ...
    <body>
        ...
        <table align="center" bgcolor="white" width="1205" height="400" frame="border">
            ...
            <td align="left" valign="top" width="500"> 
                <div align="center"   style=" overflow-y: scroll;  height: 580px;" >  <jsp:include page="selectconsume.jsp" flush="true"></jsp:include> </div> </td>
