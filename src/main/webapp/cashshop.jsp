<%-- 
    Document   : cashshop
    Created on : Jan 7, 2015, 7:55:34 AM
    Author     : THANKGOD
--%>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <li class="active">
                            <a href="cashshop.jsp" ><i class="fa fa-fw fa-file"></i> Branch Cash</a>
                        </li>
                        <li>
            ...
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    <i class="fa fa-file"></i> Cash From Shops 
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <form name="cashForm" method="post" action="selectdate.jsp" method="post" onsubmit="MM_validateForm('amountreceived','','R', 
                            'holder', '', 'R','dateselector', '','R', 'branch', '', 'R' ); return document.MM_returnValue" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="panel panel-info">
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-xs-4 text-right">Amount</label>
                                            <div class="col-md-offset-4">
                                                <input class="form-control" id="amountreceived"  name="amountreceived"  onpaste="return false;" onkeypress="return isNumberKey(event)" />
                                            </div>
                                        </div>

                                        
                                        <div class="form-group">
                                            <label class="control-label col-xs-4 text-right">Holder</label>
                                            <div class="col-md-offset-4">
                                                <input class="form-control" id="holder"  name="holder"  onpaste="return false;"  />
                                            </div>
                                        </div>


                                        <div class="form-group">
                                            <label class="control-label  col-xs-4 text-right">Branch:</label>    
                                            <div class="col-md-offset-4">
                                                <select class="form-control" name="branch" >
                                                    <option value=''> Select</option>

                                                    <option value='ca19'> CA19</option>
                                                    <option value='plaza'>Plaza</option>
                                                    <option value='b2526'>BLK 25/26</option>
                                                </select>                                          
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">               
                                            ...
                                            <label class="control-label col-xs-4   text-right">Payment Date</label>
                                            <div class="col-md-offset-4">
                                ...
                                <center> <button type="submit" name="shopcash"  class="btn btn-default" >Enter Cash</button>  </center>
