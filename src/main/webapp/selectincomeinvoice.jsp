                    ...
                    <table align="center"  class="alt1"  frame="border"  id="customer" width="1100"  height="100" valign="top" cellspacing="1">
                        ...
                        <%
                                    ...
                                    try {
                                        ...
                                        ResultSet rs = st.executeQuery("select YEAR(CURDATE()) from admin");
                                        String year = "";
                                        if (rs.next()) {
                                            year = rs.getString(1);
                                        }
                                        //out.print("C.I.= "+year);
                                        ResultSet rs2 = st.executeQuery("select count(*) from ourinvoice where branch = '" + session.getAttribute("mybranch") + "'");
                                        if (rs2.next()) {
                                            totalrecords = rs2.getInt(1);
                                        }
                                        String sql = "select * from ourinvoice where branch = '" + session.getAttribute("mybranch") + "' order by custname asc";
