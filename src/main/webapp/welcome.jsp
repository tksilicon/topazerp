<%
            ...
            session.setAttribute("pageinfo2", "Home");
%>
...
<html>
    ...
    <body>
        ...
        <table align="center" bgcolor="white" width="1205" height="400" frame="border">
            ...
            <td align="left"  valign="top"  width="210"> <jsp:include page="menu.jsp" flush="true"></jsp:include></td>

            <td align="center" valign="top">
            <jsp:include page="customerstatus.jsp" flush="true"></jsp:include> 
            <br>
             <br>
            <img src="images/acctani2.gif" alt="Drycleaning"></td>
