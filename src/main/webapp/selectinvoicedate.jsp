        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <form name="selectoldinvoice" method="get" action="dayinvoices.jsp" onsubmit="MM_validateForm('paymentdate', '','R', 'tellerno', '','R' ); return document.MM_returnValue" >
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">               
                                ...
                                <label class="control-label col-xs-3   text-right">Invoices Date</label>
