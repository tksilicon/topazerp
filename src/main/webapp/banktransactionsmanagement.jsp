<%-- 
    Document   : banktransactionsmanagement
    Created on : Dec 15, 2014, 4:07:56 PM
    Author     : THANKGOD
--%>
...
<%
    ...
    if (username != null) {
        ...
        if (request.getParameter("paymentdate") != null) {
            ...
            BankTransaction transaction  = (BankTransaction) session.getAttribute("transaction");
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <%
                ...
                ArrayList<BankTransaction> cashs = salesOPx.getAllTodayTransaction(date);
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header text-center">Bank Transactions - <%=new SimpleDateFormat("yyyy-MM-dd").format(date)%></h1>                          
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example2">
                                        ...
                                        <tbody>
                                            ...
                                            <%
                                                ...
                                                BankTransaction cash = null;

                                                int counter = 1;
                                                DecimalFormat f = new DecimalFormat("##,###.00");

                                                while (itil.hasNext()) {
                                                    cash = (BankTransaction) itil.next();
                                            ...
                                            <tr>
                                                <td><%=counter%></td> 
                                                <td><%= cash.getDate() %> </td>                                                
                                                <td><%=f.format(cash.getAmountpaid())%></td>
                                                <%if(cash.getPostedStatus().equals("notposted")){
                                                    %>
                                                     <form name="voidinvoiceform" method="post" action="transactvoidaction.jsp" >
                                                        <td class="center"><button type="submit" class="btn btn-primary" name="voidbanktransaction" value="<%=cash.getId() %>"> Void Bank Transaction</button></td>
                                                         <input type="hidden" name="voiddate" value="<%=new SimpleDateFormat("yyyy-MM-dd").format(cash.getDate())%>">
