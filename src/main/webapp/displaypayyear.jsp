...
<html>
    ...
    <body>
        ...
        <table align="center" bgcolor="white" width="1205" height="400" frame="border">
            ...
            <td align="right" width="300" valign="top"><div align="center"   style=" overflow-y: scroll;  height: 580px;" >   <jsp:include page="selectpayyear.jsp" flush="true" ></jsp:include> </div> </td>
    <%--
