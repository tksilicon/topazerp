        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <form action="registercustomer.jsp" method="post"  name="newcustomerForm" onsubmit="MM_validateForm('customerbalance','','R', 'customerbalancetype', '', 'R',
                            'customerbal2014', '','R', 'customerbalance2014', '','R', 'customerbal2013', '','R', 'customerbalance2013','', 'R', 'surname','','R' ); return document.MM_returnValue">
                            <div class="col-lg-6" > 
                                ...
                                <div class="panel panel-default">                
                                    <div class="panel-body">   
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-offset-4">
                                                <input   class="form-control" name="custno" value="<%= salesOpx.generateCustomerNumber(staff)%>" readonly="readonly" />                                  
                                            </div> 
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label  text-right col-xs-3">CustBalType </label>                                 
                                            <div class="col-md-offset-4">
                                                <select  class="form-control" name="customerbalancetype" />  
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-xs-3 text-right">Credit 2014</label>                                 
                                                <div class="col-md-offset-4">
                                                    <input   class="form-control"  min="0" value="0.0" name="customerbal2014" />                                  
                                                </div>
                                            </div>
                                            
                                            <div class="form-group">
                                            <label class="control-label  text-right col-xs-3">CustBal2014 </label>                                 
                                            <div class="col-md-offset-4">
                                                <select  class="form-control" name="customerbalance2014" />  
                                                <option value=''> select</option>
                                                <option value="positive">positive</option>
                                                <option value="negative">negative</option>
                                                </select>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-xs-3 text-right">Credit 2013</label>                                 
                                                <div class="col-md-offset-4">
                                                    <input   class="form-control"  min="0" value="0.0" name="customerbal2013" />                                  
                                                </div>                               
                                            </div>
                                            
                                            <div class="form-group">
                                            <label class="control-label  text-right col-xs-2">CustBal2013</label>                                 
                                            <div class="col-md-offset-4">
                                                <select  class="form-control" name="customerbalance2013" />  
                                                <option value=''> select</option>
                                                <option value="positive">positive</option>
                                                <option value="negative">negative</option>
                                                </select>
                                            ...
                                            <br>
                                            <div class="form-group">
                                                <label class="control-label  text-right col-xs-2">Birth(Day)</label>                                 
                                                <div class="col-xs-4">
                                                ...
                                                <label class="control-label  text-right col-xs-2"> Birth(Month)</label>
                                                <div class="col-xs-4">
                                            ...
                                            <div class="form-group">                                             
                                                <div class="col-md-offset-2">
                                                    <button type="submit" name="newcustomer" class="btn btn-default form-control">Register</button>
