...
<%@page import="com.topazerp.sales.errors.*"%>
<%
            ...
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <%
                        ...
                        ArrayList sales = salesOPx.getTodaySales(staff.getBranch());
                    ...
                    <div class="row">
                        <div class="form-group">
                            <div class="col-lg-4">
                                <a href="invoices.jsp" role="button" class="btn btn-success btn-large">New Invoice</a>
                            </div>
                        </div>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <form name="voidinvoiceform" method="post" action="invoiceaction.jsp" >
                                        <td class="center"><button type="submit" class="btn btn-primary" name="voidinvoice" value="<%=sale2.getInvoiceNo()%>"> Void Invoice</button></td>
                                         <input type="hidden" name="dateforsupply" value="<%=new SimpleDateFormat("yyyy-MM-dd").format(new Date())%>">
                                    ...
                                    <form name="postforSupplyform" method="post" action="invoicepost2.jsp" >
