<%-- 
    ...
    Created on : Dec 18, 2014, 2:11:41 PM
    Author     : THANKGOD
--%>
            ...
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <form name="expensesForm" method="post" action="selectdate.jsp" method="post" onsubmit="MM_validateForm('fundAmount','','R', 'dateselector','','R'); return document.MM_returnValue" >
                                    ...
                                    <div class="panel panel-info">
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-xs-4">Funds Amounts</label>
                                                <div class="col-md-offset-4">
                                                    <input class="form-control" id="fundAmount"  name="fundAmount"  onpaste="return false;" onkeypress="return isNumberKey(event)" />
                                                </div>
                                            </div>
                                        ...
                                        <center> <button type="submit" name="fundexpenses"  class="btn btn-default" >Fund Expenses</button>  </center>
