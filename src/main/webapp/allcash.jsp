<%-- 
    Document   : allcash
    Created on : Jan 29, 2015, 4:18:38 AM
    Author     : THANKGOD
--%>
...
<%
    ...
    if (username != null) {
        ...
        if (request.getParameter("printcash") != null) {
            SalesOperations salesOpx = new SalesOperations();
            CashShop cash = (CashShop) session.getAttribute("cash");
            date = cash.getDateCash();
            

            salesOpx.insertCash(cash, staff.getBranch());
    ...
    <body>
        ...
        <div id="wrapper">
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li class="active">
                                <a href="cashshop.jsp"><i class="fa fa-fw fa-file"></i> Cash Shop</a>
                            </li>
                            <li>
            ...
            <%
                ...
                SalesOperations salesOPx = new SalesOperations();
                ArrayList<CashShop> cashs = salesOPx.getAllCash(date);
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header text-center">Odic Cash From Shops - <%=new SimpleDateFormat("yyyy-MM-dd").format(OdicUtil.convertJavaSqlDateToNormalDate(date)) %></h1>                          
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><%=counter%></td> 
                                                <td><%= cash.getCashNo() %> </td>
                                                <td><%=cash.getBranch() %></td> 
                                                <td><%=f.format(cash.getAmount()) %></td>
                                                <td><%=cash.getHolder() %></td>                                    
                                                <td><%=cash.getDateCash() %></td>  
                                                <%if(cash.getPostedStatus().equals("notposted")){
                                                    %>
                                                     <form name="voidinvoiceform" method="post" action="transactvoidaction.jsp" >
                                                        <td class="center"><button type="submit" class="btn btn-primary" name="voidcash" value="<%=cash.getCashNo()%>"> Void Cash</button></td>
                                                         <input type="hidden" name="voiddate" value="<%=new SimpleDateFormat("yyyy-MM-dd").format(cash.getDateCash())%>">
