...
<%
    ...
    if (username != null) {
        ...
        if (request.getParameter("action") == null) {
            response.sendRedirect("odicsales.jsp");
    ...
    <head>
        ...
        <script type="text/JavaScript">
            ...
            function MM_validateForm() { //v4.0
                ...
                var x = document.forms["selectForm"]["productQuantity"].value;
                if (x == null || x == "" || x < 1) {
                    alert("Enter quantity to be purchased");
                    return false;
                }
            } **/
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="navbar-header">
                    ...
                    <a class="active navbar-brand" href="invoices.jsp">ODIC SALES</a>
                </div>
                <!-- Top Menu Items -->
            ...
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <form  id="selectForm" class="form-horizontal" action="selectproductsaction.jsp" method="post" onsubmit="MM_validateForm('productselect', '', 'R','quantitydisplay','','R', 'retailwholesale', '', 'R','pricetype', '','R' ); return document.MM_returnValue" >
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <select name="productselect"  class="form-control">
                                            ...
                                            <%
                                                ...
                                                session.setAttribute("prodList", odicProducts);
                                            %>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-2">
                                    <select  class="form-control" name="retailwholesale" /> 
                                    <option value=''> Select</option>
                                    <option value='retail'> Retail Price</option>
                                    <option value='lowerretail'> Lower Retail Price</option>
                                   
                                    
                                    <option value='wholesale'> Wholesale Price</option>
                                    <option value='lowerwholesale'> Wholesale Lower </option>                                   
                                    </select>
                                </div>          
                            ...
                            <div class="form-group">
                                <label class="control-label col-xs-3">Client Discount</label>
                                <div class="col-xs-6">
                                    <input   class="form-control" name="shadowdisplay"  onpaste="return false;" onkeypress="return isNumberKey(event)" />
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="control-label  col-xs-3">Type of Client </label>                                 
                                <div class="col-xs-2">
                                    <select  class="form-control" name="typeOfShadow" />  
                                    <option value="item"> Item</option>
                                    </select>
                                </div>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            %>
                                            <%=  f.format(prod.getTotalProductDiscount())%>
                                            <%
                                                }
                                        ...
                                        <td>
                                            ...
                                            <%=  f.format(prod.getTotalShadowPrice())%>
                                            <%
                                                }
                                        ...
                                        <td>
                                            ...
                                            <%=  f.format(prod.getSubTotalAfterShadow())%>
                                            <%
                                                }
                                    ...
                                    %>
                                    <tr><td> 
                                            <button type="submit" name="cashinvoice" value="cashinvoice" class="btn btn-xs btn-primary" onclick ='this.form.onsubmit="return validateForm2()"; this.form.action="salesdispatch.jsp";'>Cash</button>
                                        </td>
                                        <td> 
                                            <%
                                                if (staff.getBranch().equals("HEADOFFICE_SALES")) {
                                            %>
                                            <button type="submit" name="creditinvoice" value="creditinvoice" class="btn btn-xs btn-primary" onclick ='this.form.onsubmit="return validateForm2()"; this.form.action="salesdispatch.jsp";'>Credit</button>
                                            <% }%>
                                        </td>
                                        ...
                                        <td> 
                                            <%
                                                if (staff.getBranch().equals("HEADOFFICE_SALES")) {
                                            %>
                                            <button type="submit" name ="cashcreditinvoice" value="cashcreditinvoice" class="btn btn-xs btn-primary" onclick ='this.form.onsubmit="return validateForm2()"; this.form.action="salesdispatch.jsp";'>Cash/Credit</button>
                                            <% }%>
                                        </td>                                                      
