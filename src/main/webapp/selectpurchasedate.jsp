...
<html>
    ...
    <body>
        ...
        <table align="center"  class="rowHover"  frame="border"  id="customer" width="940"  height="100" valign="top" >
            ...
            <%
             DecimalFormat formatter = new DecimalFormat("###,###,###");
                        if (request.getParameter("purchaseday") != null) {
                            ...
                            try {
                                ...
                                String sql = "select id, date, name, qty, price, total, amtpaid, balance, vendor, staff from purchase where date = '" + kw + "' ";
