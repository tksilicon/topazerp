...
session.setAttribute("pageinfo2", "Bank Withdrawal");
%>
<%-- 
    Document   : welcome
    ...
    <body>
        ...
        <table align="center" bgcolor="white" width="1205" height="400" frame="border">
            ...
            <td align="left" width="210" valign="top"> 
                 ...
                 <form action="displaywithdrawalsort.jsp" method="post">
        ...
        <table align="center"    frame="border"  width="720"  height="30" valign="top">
            ...
            <TR valign="center" bgcolor="#eeeeee" align="center" height="30">
                ...
                <div align="center"   style=" overflow-y: scroll;  height: 480px;" > 
                    <table align="center"  class="Hover"  frame="border"  id="customer" width="720"  height="100" valign="top">
                    ...
                    <%
                        ...
                        try {
                            ...
                            String sql = "select * from withdraw where date between '" + d1 + "' and '" + d2 + "'";
                    ...
                    <tr bgcolor="#eeeeee">
                        ...
                        <TD align="center"><FONT FACE="tahoma" SIZE="2" color="gray"><%= set.getString("chequeno")%></FONT></TD>

                        <TD align="left"><FONT FACE="tahoma" SIZE="2" color="gray"><%=set.getString("withdrawal")%></FONT></TD>

                        <TD align="right"><FONT FACE="tahoma" SIZE="2" color="gray"><%=set.getFloat("amount") + "0"%></FONT></TD>

                        <TD align="left"><FONT FACE="tahoma" SIZE="2" color="gray"><%=set.getString("bank")%></FONT></TD>

                        <TD align="left"><FONT FACE="tahoma" SIZE="2" color="gray"><%=set.getString("account")%></FONT></TD>

                        <td align="center"><a href="deleting.jsp?deletewithdraw=<%=set.getInt("id")%>"><input type="button" name="Delete" value="Void" style="background-color:#ff0000;font-weight:bold; font-size: x-small; color:#ffffff;" onclick="javascript:return confirm('Are you sure you want to void this withdrawal ?')"   ></a></td>
