...
--%>
 ...
 <%
       ...
       // if(request.getAttribute("staff") == null){
           ...
           //response.sendRedirect("http://localhost:8080/ROOT/");   
...
<html>
    ...
    <body>
        ...
        newpackage.StaffStatus staff = (newpackage.StaffStatus)request.getAttribute("staff");
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.jsp">ODIC SALES</a>
                </div>
                <!-- Top Menu Items -->
                <ul class="nav navbar-right top-nav">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i>  <%= id.toUpperCase() %>  <b class="caret"></b></a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <%
                                                ...
                                                int todayscounter = salesopx.getDailySalesCounter();

                                                if (request.getParameter("printinvoice") != null) {
                                                    todayscounter += 1;
                                                    salesopx.updateDailySalesCounter(todayscounter);
                                                }
