...
<html>
    ...
    <body>
        ...
        <table align="center" dir="LTR"  id="customer" class="rowHover"  frame="border"  width="940"  height="100" valign="top">
            ...
            <%
                        ...
                        if (request.getParameter("paymentday") != null) {
                            ...
                            try {
                                ...
                                String sql = "select id, branch, date, accountname, vendor, address, phoneno, prev_balance, description, amountpaid, balance, paid_by from payment where date =  '" + kw + "' ";
