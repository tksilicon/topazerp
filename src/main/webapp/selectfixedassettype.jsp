    ...
    <body>
        ...
        <table align="center" class="alt1"   frame="border"  id="customer" width="900"  height="100" valign="top" cellspacing="1">
            <TR valign="center" bgcolor="#333366" align="center" height="30">
                ...
                <TD align="center"><FONT FACE="tahoma" SIZE="2" color="blue"><B>Depreciation</B></FONT></TD>
             ...
             DecimalFormat formatter = new DecimalFormat("###,###,###");
                        ...
                        if (request.getParameter("type") != null) {
                            ...
                            try {
                                ...
                                String sql = "select * from fixedasset where account = '" + kw + "'";
        ...
        <table align="center" dir="LTR"   frame="border"  width="900"  height="30" valign="top">
            ...
            <form action="displayfixedasset.jsp" method="post">
                <td align="right"> <INPUT NAME="export" TYPE="submit" VALUE="View All FixedAsset" style="background-color:#330099;font-weight:bold;color:#ffffff;" />
                </td>
            </form>
        </tr>
    </table>

    <table align="left" dir="LTR"      width="600"  height="50" >
        <tr

    </tr>
</table>
<table align="left" dir="LTR"      width="600"  height="100" >
    ...
    <%
                ...
                double total = ab.totalassetcosttype(kw);
                double nbv = ab.totalassetnbvtype(kw);
                double depre = ab.totalassetcosttype(kw)  -  ab.totalassetnbvtype(kw);
    ...
    <tr>
        <td><font size="3" face="arial" color="blue"><U>FIXED ASSET SUMMARY FOR <%=kw.toUpperCase() %></U></font></td>
    </tr>
