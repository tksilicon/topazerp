<%
            ...
            session.setAttribute("pageinfo", "Closed/Verified Invoices");
%>
<%-- 
    Document   : welcome
        ...
        <table align="center" bgcolor="white" width="1205" height="600" frame="border">
            ...
            <td>
                <INPUT NAME="print" TYPE="button" VALUE="Print this Document" style="background-color:#330099;font-weight:bold;color:#ffffff; height:  35px;" 
                    ...
                    <br>
                    <br>
                <div align="right"    style=" overflow-y: scroll;  border:  scrollbar; width: 1190px; height: 40px;" >
                    ...
                    <table align="center"  class="alt1"  frame="border"  id="customer" width="1100"  height="100" valign="top" cellspacing="1">
                        ...
                        <%
                                    ...
                                    try {
                                        ...
                                        //    year = rs.getString(1);
                                        //}
                                        ResultSet rs2 = st.executeQuery("select count(*) from ourinvoice where branch = '" + session.getAttribute("mybranch") + "' and verify = 'Verified'");
                                        if (rs2.next()) {
                                            totalrecords = rs2.getInt(1);
                                        }
                                        //out.print("C.I.= "+year);
                                        String sql = "select * from ourinvoice where branch = '" + session.getAttribute("mybranch") + "' and verify = 'Verified'";
                        ...
                        <TR bgcolor="#eeeeee">
                            ...
                            <td align="center"><FONT FACE="tahoma" SIZE="2" color="green">Verified</FONT></td>
