...
<html>
    ...
    <body>
        ...
        <table align="center" class="rowHover"   frame="border" id="customer"  width="780"  height="100" valign="top">
            ...
            <%
                ...
                try {
                    ...
                    String sql = "select * from custpref";
            ...
            <TR bgcolor="#eeeeee">
                ...
                <TD align="center"><FONT FACE="tahoma" SIZE="2" color="gray"><%=set.getString("date".toUpperCase())%></FONT></TD>
                
                <TD align="center"><FONT FACE="tahoma" SIZE="2" color="gray"><%= set.getString("Customerno".toUpperCase())%></FONT></TD>
                
                <TD align="center"><FONT FACE="tahoma" SIZE="2" color="gray"><%=set.getString("preference")%></FONT></TD>
                
                <TD align="center"><FONT FACE="tahoma" SIZE="2" color="gray"><%=set.getString("priority")%></FONT></TD>
        ...
        <table align="center" dir="LTR"   frame="border"  width="780"  height="30" valign="top">
