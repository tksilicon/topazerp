            ...
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <!-- /.row -->
                         ...
                         <form action="paymenttypeactioncc.jsp" method="post" onsubmit="MM_validateForm('paymenttype', '', 'R'); return document.MM_returnValue" >
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                <label class="control-label  col-xs-2">Payment Type </label>  
                                <div class="col-xs-6">
                                ...
                                <button type="submit" name="paymenttypegen" class="btn btn-default">Continue</button>
                            </div>                          
                        </div>
