        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <form name="oldInvoice" method="get" action="selectproductscic.jsp" onsubmit="MM_validateForm('invoicedate', '','R', 'address', '','R'); return document.MM_returnValue" >
                            ...
                            <div class="col-lg-6"> 
                                ...
                                <div class="form-group">               
                                    ...
                                    <div class="col-md-offset-3">
                                        <input   class="form-control" type="date" id="invoicedate" name="paymentdate"  onpaste="return false;"  />   
                                         <input   class="form-control" type="hidden"  name="action" value="old"  onpaste="return false;"  />   
                                    </div>                                    
                                </div>
