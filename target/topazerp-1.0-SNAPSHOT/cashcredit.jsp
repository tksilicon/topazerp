        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <form name="purchaseForm" method="post" action="cashcreditaction.jsp" onsubmit="return validateForm()" >
                            ...
                            <div class="col-lg-6">  
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-offset-3">
                                        <input   class="form-control" value="<%= f.format(sale.getTotalAfterShadowDiscount())%>" readonly="readonly" />                                  
                                    </div>
                                </div>
                                ...
                                <div class="form-group">                 
                                    ...
                                    <label class="control-label col-xs-3   text-right">Enter Amount paid</label>     

                                    <div class="col-md-offset-3">
                                        <input   class="form-control" value="0.0" min="0" type="number" step="2" type=""id="amountpaidinput" name="amountpaidinput"  onpaste="return false;" onkeypress="return isNumberKey(event)" />                                  
                                    </div>                                    
                                </div>


                                <div class="form-group text-center">
                                    <button type="submit" name="cshcreditgen" class="btn btn-default">Continue</button>
                                </div>
                            </div>            
