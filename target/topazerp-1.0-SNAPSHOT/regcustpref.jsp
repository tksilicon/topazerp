...
if(session.getAttribute("username") == null){
 ...
 session.setAttribute("pageinfo2", "New Cust. Pref.");
%>
<%-- 
    Document   : welcome
...
<html>
    <head>
        ...
        <title>Customers' Preferences</title>
    </head>
    <body>
        ...
        <table align="center" bgcolor="white" width="1205" height="400" frame="border">
            ...
            <td align="center" valign="top"> <jsp:include page="newcustpref.jsp" flush="true"></jsp:include></td>
