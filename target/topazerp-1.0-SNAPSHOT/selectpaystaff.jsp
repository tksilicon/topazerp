...
<html>
    ...
    <body>
        ...
        <table align="center" class="rowHover" dir="LTR"  id="customer"  frame="border"  width="940"  height="100" cellspacing="1">
            ...
            <%
                        if (request.getParameter("paystaff") != null) {


                            String value2 = request.getParameter("year");
                            String kw2 = String.valueOf(value2);

                            String value = request.getParameter("staffname");
                            ...
                            try {
                                ...
                                String sql = "select * from payrecords where year = '" + kw2 + "' AND names = '" + kw + "'";
            ...
            <TR bgcolor="#eeeeee">
                ...
                <TD align="center"><FONT FACE="tahoma" SIZE="2" color="gray"><%=set.getFloat(9)%></FONT></TD>

                <TD align="center"><FONT FACE="tahoma" SIZE="2" color="gray"><%=set.getFloat(10)%></FONT></TD>

                <TD align="center"><FONT FACE="tahoma" SIZE="2" color="gray"><%=set.getFloat(11)%></FONT></TD>

                <TD align="center"><FONT FACE="tahoma" SIZE="2" color="gray"><%=set.getFloat(12)%></FONT></TD>

                <TD align="center"><FONT FACE="tahoma" SIZE="2" color="gray"><%=set.getFloat(13)%></FONT></TD>
                <TD align="center"><FONT FACE="tahoma" SIZE="2" color="gray"><%=set.getFloat(14)%></FONT></TD>



                <td><a href="deleting.jsp?deletepay=<%=set.getInt(1)%>"><input type="button" name="Delete" value="Void Payroll" style="background-color:#ff0000;font-weight:bold; font-size: x-small; color:#ffffff;"  ></a></td>
