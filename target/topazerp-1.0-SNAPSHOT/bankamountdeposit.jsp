<%-- 
    Document   : bankamountdeposit
    Created on : Jan 5, 2015, 11:22:49 AM
    Author     : THANKGOD
--%>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <form name="purchaseForm" method="post" action="cashamountaction.jsp" onsubmit="MM_validateForm('amountpaidinput','','R', 'depositbank', '', 'R','paymentdate', '','R', 'tellerno', '','R' ); return document.MM_returnValue" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">  
                                ...
                                <div class="form-group">
                                    ...
                                    if (sale.getPaymentType().equals("bankdeposit")) {
                                ...
                                <div class="form-group">               
                                    ...
                                    <div class="col-md-offset-3">
                                        <input   class="form-control"  id="tellerno" name="tellerno"  onpaste="return false;" />                                  
                                    </div>                                    
                                </div>
