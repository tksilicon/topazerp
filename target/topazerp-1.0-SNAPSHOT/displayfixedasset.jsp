...
session.setAttribute("pageinfo2", "Fixed Asset ");
%>
...
<html>
    ...
    <body>
        ...
        <table align="center" bgcolor="white" width="1205" height="360" frame="border">
            ...
            <td align="right" width="210"  valign="top"><div align="center"   style=" overflow-y: scroll;  height: 580px;" >   <jsp:include page="selectfixedasset.jsp" flush="true" ></jsp:include> </div> </td>
