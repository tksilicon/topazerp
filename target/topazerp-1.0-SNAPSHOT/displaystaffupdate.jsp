...
session.setAttribute("pageinfo2", "Staff Update");
%>
...
<html>
    ...
    <body>
        ...
        <table align="center" bgcolor="white" width="1205" height="400" frame="border">
            ...
            <td align="right" width="210"  valign="top"> <div align="center"   style=" overflow-y: scroll;   height: 480px; width: 950px;" >  <jsp:include page="updatestaff.jsp" flush="true" ></jsp:include> </div> </td>
