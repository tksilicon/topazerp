        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <form name="purchaseForm" method="post" action="cashamountaction.jsp" onsubmit="MM_validateForm('amountpaidinput','','R', 'depositbank', '', 'R','paymentdate', '','R', 'chequeno', '','R' ); return document.MM_returnValue" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">  
                                ...
                                <div class="form-group">
                                    ...
                                    <%
                                        if (sale.getPaymentType().equals("cheque")) {
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="control-label col-xs-3   text-right">Cheque No</label>
                                    <div class="col-md-offset-3">
                                        <input   class="form-control"  id="tellerno" name="chequeno"  onpaste="return false;" />                                  
                                    </div>                                    
                                </div>
