<%-- 
    Document   : oldinvoice
    Created on : Jan 20, 2015, 4:35:33 AM
    Author     : THANKGOD
--%>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <form name="selectoldinvoice" method="post" action="reciptscashaction.jsp" onsubmit="MM_validateForm('paymentdate', '','R', 'tellerno', '','R' ); return document.MM_returnValue" >
                        ...
                        <div class="row">
                            <div class="col-lg-6"> 
                                ...
                                <div class="form-group">               
                                    ...
                                    <div class="form-group text-center">
                                        <button type="submit" name="oldreceiptsubmit" class="btn btn-default">Continue Receipts</button>
                                    </div>
                                    <div class="form-group text-center">
                                        <button type="submit" name="oldcashsubmit" class="btn btn-default">Continue Cash</button>
                                    </div>


                                    <div class="form-group text-center">
                                        <button type="submit" name="oldexpensesubmit" class="btn btn-default">Continue Fund Expenses</button>
                                    </div>
                                    
                                     <div class="form-group text-center">
                                        <button type="submit" name="oldbanksubmit" class="btn btn-default">Continue Bank Transaction</button>
                                    </div>
                                </div>
