    ...
    <body>
        ...
        <%
                    ...
                    try {
                        ...
                        ResultSet rs = st.executeQuery("SELECT  DAY(getDate()), MONTH(getDate()), YEAR(getDate()) from extrainfo ");
        ...
        <table align="center" dir="LTR" class="rowHover"  id="customer"  frame="border"  width="940"  height="100" valign="top">
            ...
            int i = 0;
                        if (request.getParameter("incomename") != null) {
                            ...
                            try {
                                ...
                                String sql = "SELECT branch, Date, custname,  invoiceid, amtpaid, staff, '"+type2+"' from ourinvoice where amtpaid >0 AND custtype ='regular' AND date ='" + date + "'  UNION ALL SELECT branch, Date, custname, invoiceid, amtpaid, staff, '"+type1+"'  from pickup where amtpaid > 0 AND custtype ='regular' AND date ='" + date + "' ";
            ...
            <TR bgcolor="#eeeeee">
                ...
                <TD align="center"><FONT FACE="tahoma" SIZE="2" color="gray"><%=set.getString(4)%></FONT></TD>
                 <TD align="center"><FONT FACE="tahoma" SIZE="2" color="blue">Regular</FONT></TD>
        ...
        <tr align="left" width="100">
            <td>
                <%
                                              ...
                                              double total1 = bal.totalincome1(date);
                                              double total2 = bal.totalincome2(date);
                                              double total3 = bal.totalincome3(date);
                                              double gtotal = total1 + total2;
                                              double gtotal2 = gtotal + total3;

                %>

                <font color="blue" face="tohoma" size="4"> Total Income on the <%= date%> = &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;  N<%out.print(formatter.format(gtotal));%>.00</font>
        </tr>
        <tr>
            <td>
