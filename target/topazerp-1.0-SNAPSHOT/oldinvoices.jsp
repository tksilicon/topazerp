...
<%
    ...
    if (username != null) {
        ...
        //staff.setTempInvoiceDate();
        //staff.setOldProduct("true");
                                ...
                                <div class="panel panel-default">                
                                    <div class="panel-body">   
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="control-label  text-right col-xs-2">Custype</label>                                 
                                            <div class="col-xs-4">
                                        ...
                                        <br>
                                        <div class="form-group">
                                            <label class="control-label col-xs-4 text-left">Birth Day (M/D)</label>                                 
                                            <div class="col-xs-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8">
                                        <select name="customerselect"  class="form-control">
                                            ...
                                            %>
                                            <option value="<%=regno%>"><%=custname + " " + regno + " " + phone + " " + bal%></option>
                                            <%
                                                    phone = "";
                                                }
