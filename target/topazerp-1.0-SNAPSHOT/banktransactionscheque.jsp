<%-- 
    Document   : banktransactionscheque
    Created on : Dec 15, 2014, 1:07:49 PM
    Author     : THANKGOD
--%>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header text-center">
                                Today's  <small>Bank Transaction</small>
                            </h1>
                            <ol class="breadcrumb">
                                <li>
                                ...
                                <li class="active">
                                    <i class="fa fa-file"></i> Bank Transactions
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <form name="purchaseForm" method="post" action="cashcreditaction.jsp" method="post" onsubmit="MM_validateForm('amountpaidin','','R', 'bankpayed', '', 'R','chequeno', '','R', 'customername', '', 'R' ); return document.MM_returnValue" >
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-offset-4">
                                                <input class="form-control" id="amountpaidinput"  name="amountpaidin"  onpaste="return false;" onkeypress="return isNumberKey(event)" />
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="control-label col-xs-4 ">Bank Deposited</label>
                                            <div class="col-md-offset-4" >
                                                <input class="form-control"  name="bankpayed"   />
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="control-label col-xs-4">Cheque No</label>
                                            <div class="col-md-offset-4">
                                            ...
                                            <div class="col-md-offset-4">
                                                <select class="form-control" name="customerselect" >
                                                    ...
                                                    <%
                                                        ...
                                                        //Collections.sort(odicCustomers, Customer.CustomerComparator);
%>
                                                    <%
                                                        itil = odicCustomers.iterator();
                                                        while (itil.hasNext()) {
                                                            cust = (Customer) itil.next();
                                                    ...
                                                    %>
                                                    <option value="<%=cust.getRegno()%>"><%= cust.getCustname()%></option>
                                                    <%
                                ...
                                <center> <button type="submit" name="bankcash"  class="btn btn-default" >Enter Transaction</button>  </center>
