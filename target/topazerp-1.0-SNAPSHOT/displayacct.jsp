...
if(session.getAttribute("username") == null){
 ...
 session.setAttribute("pageinfo2", "Chart of Acct.");
%>
...
<html>
    ...
    <body>
        ...
        <table align="center" bgcolor="white" width="1205" height="400" frame="border">
            ...
            <td align="left" width="210" valign="top"> <div align="center"   style=" overflow-y: scroll;  height: 580px;" >  <jsp:include page="selectacct.jsp" flush="true"></jsp:include> </div>  </td>
