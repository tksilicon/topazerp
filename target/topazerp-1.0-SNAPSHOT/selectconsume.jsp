    ...
    <body>
        ...
        <table align="center"  class="alt1"  frame="border"  id="customer" width="940"  height="100" valign="top" cellspacing="1">
            ...
            <TR bgcolor="#eeeeee">
                ...
                <TD align="right"><FONT FACE="tahoma" SIZE="2" color="#444444"><%=formatter.format(set.getFloat(4))%></FONT></TD>

                <TD align="right"><FONT FACE="tahoma" SIZE="2" color="#444444"><%=formatter.format(set.getFloat(5))%></FONT></TD>
