        ...
        <%
          ...
          <table align="center" dir="LTR"  class="alt1" id="customer"  frame="border"  width="940"  cellspacing="1">
            ...
            <%
                        ...
                        //String de = df.format(new java.util.Date());
                        String type = "";
                        if (request.getParameter("type") != null) {
                            ...
                            try {
                                ...
                                ResultSet rs2 = st.executeQuery("select count(*) from expenses where type = '" + kw + "' ");
                                if (rs2.next()) {
                                    totalrecords = rs2.getInt(1);
                                }
                                String sql = "select id, branch, expense_date, accountname, receiver, address, phoneno, total_amount, description, amountpaid, balance, approved_by, type from expenses where type = '" + kw + "' ";
//id, branch, expense_date, accountname, receiver, address, phoneno, total_amount, description, amountpaid, balance, approved_by, type from expenses
        ...
        <table align="center" dir="LTR"   frame="border"  width="940"  height="30" valign="top">
            ...
            <form>
                <td align="right"> <INPUT NAME="export3" TYPE="button" VALUE="Export to Excel" onclick="generateexcel();" style="background-color:#330099;font-weight:bold;color:#ffffff;" />
                </td>
            </form>
    ...
    <table align="left" dir="LTR"      width="600"  height="100" valign="top">
        ...
        <%
                                        ...
                                        double total = ab.expensetype(kw);
        ...
        <tr>
            <td><font size="3" face="arial" color="blue"><U>TOTAL EXPENSES FOR <%= kw.toUpperCase()%></U></font></td>
        </tr>
