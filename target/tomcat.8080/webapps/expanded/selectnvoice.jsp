...
<html>
    ...
    <body>
        ...
        <table align="center"  class="alt1"  frame="border"  id="customer" width="900" cellpadding="1" cellspacing="1" >
            ...
            <TR bgcolor="#eeeeee" height="25">
                <TD align="left" width="60"><FONT FACE="tahoma" SIZE="2" color="#444444"><%=set.getString("date")%></FONT></TD>
                <TD align="center" width="70"><FONT FACE="tahoma" SIZE="2" color="#444444"><a href="selectincomeitemwtdt.jsp?invidd=<%=set.getString("invoiceid")%>"><%=set.getString("invoiceid")%></a></FONT></TD>

                <TD align="left" width="50"><FONT FACE="tahoma" SIZE="2" color="#444444"><%=set.getString("branch")%></FONT></TD>


                <TD align="left" width="150"><FONT FACE="tahoma" SIZE="2" color="#444444"><%=set.getString("custname")%></FONT></TD>

                <TD align="left" width="60"><FONT FACE="tahoma" SIZE="2" color="#444444"><%=set.getString("custtype")%></FONT></TD>
                <TD align="left" width="80"><FONT FACE="tahoma" SIZE="2" color="#444444"><%=set.getString("tagno")%></FONT></TD>

                <TD align="center" width="30"><FONT FACE="tahoma" SIZE="2" color="#444444"><%=set.getInt("totalqty")%></FONT></TD>

                <TD align="right" width="50"><FONT FACE="tahoma" SIZE="2" color="#444444"><%=formatter.format(set.getFloat("grandtotal"))%></FONT></TD>

                <TD align="right" width="50"><FONT FACE="tahoma" SIZE="2" color="#444444"><%=formatter.format(set.getFloat("amtpaid"))%></FONT></TD>

                <TD align="right" width="50"><FONT FACE="tahoma" SIZE="2" color="#444444"><%=formatter.format(set.getFloat("balance"))%></FONT></TD>


                <TD align="center" width="50"><FONT FACE="tahoma" SIZE="2" color="#444444"><%=set.getString("staff")%></FONT></TD>

                <td align="center" width="50"><a href="displayupdateinvoice.jsp?name=<%=set.getString("invoiceid")%>"><img src="images/upimg.gif"  ></a></td>
