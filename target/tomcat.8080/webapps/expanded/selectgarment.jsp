                ...
                <div align="right"    style=" overflow-y: scroll;  border:  scrollbar; width: 1190px; height: 480px;" >
                    ...
                    <table height="10">
                        ...
                        <%
                            ...
                            String dat = "";
                            try {
                                if (request.getParameter("vnewdate") != null) {

                                    String value = request.getParameter("snewdate");
                                    ...
                                    String sql = "select  * from initialinsp where tdate = '" + kw + "'";
                                    String sql1 = "select count(*) from initialinsp where tdate = '" + kw + "' AND itemtype = 'Suits'  ";
                                    String sql2 = "select count(*) from initialinsp where tdate = '" + kw + "' AND itemtype = 'Shirts'";
                                    String sql3 = "select count(*) from initialinsp where tdate = '" + kw + "' AND itemtype ='Natives'";
                                    String sql4 = "select count(*) from initialinsp where tdate = '" + kw + "' AND itemtype ='Casuals'";
                                    String sql5 = "select count(*) from initialinsp where tdate = '" + kw + "' AND itemtype ='Beddings'";

                                    String sql6 = "select count(*) from initialinsp where tdate = '" + kw + "' AND itemtype ='Curtains'";
                                    String sql7 = "select count(*) from initialinsp where tdate = '" + kw + "' AND indexcode ='D'";
                                    String sql8 = "select count(*) from initialinsp where tdate = '" + kw + "' AND indexcode ='L'";
                                    String sql9 = "select count(*) from initialinsp where tdate = '" + kw + "' AND indexcode ='P'";
                        %>
                        ...
                        <tr bgcolor="#eeeeee">
                            ...
                            <td align="center"><FONT FACE="tahoma" SIZE="2" color="gray"><%=set7.getString("tdate")%></FONT></td>
                            <td align="center"><FONT FACE="tahoma" SIZE="2" color="gray"><%=set7.getString("day")%></FONT></td>
                            <% }%>
                            <%
