<%-- 
    Document   : custbal
    Created on : Jan 17, 2015, 1:05:55 AM
    Author     : THANKGOD
--%>
    ...
    <body>
        ...
        <div id="wrapper">
                    ...
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                             ...
                             <li>
                                <a href="addcustomers1.jsp" ><i class="fa fa-fw fa-file"></i> Register</a>
                            </li>
                                <%
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header text-center">Odic Customer Balances</h1>                          
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                You can search for customer balance to view
                            </div>
                            <!-- /.panel-heading -->
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example2">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Customer Bal2014</th>
                                                <th>Customer Bal2013</th>
                                                <th>Credit Limit</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <%
                                                ...
                                                ArrayList<CustomerCredit> custBals = salesOpx.getCreditBalances();
                                                DecimalFormat formatter = new DecimalFormat("###,###.00");
                                                
                                                


                                                Iterator itil = custBals.iterator();
                                                CustomerCredit crdt = null;

                                                while (itil.hasNext()) {

                                                    crdt = (CustomerCredit) itil.next();
                                                    counter++;
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="left"> <%= crdt.getRegno()%></td>

                                                <td class="left"> <%= crdt.getSurname().toUpperCase() %></td>
                                              


                                                 <td><%=formatter.format(crdt.getCustomerBalance())%></td> 
                                                <td><%= formatter.format(crdt.getCustomerbal2014()) %></td>
                                                  <td><%= formatter.format(crdt.getCustomerbal2013()) %></td>
                                                  <td><%= formatter.format(crdt.getCreditLimit()) %></td>
