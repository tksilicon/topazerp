<%-- 
    Document   : allfundexpenses
    Created on : Dec 20, 2014, 6:37:31 PM
    Author     : THANKGOD
--%>
...
<%
    ...
    if (username != null) {
        ...
        session.removeAttribute("fundexpenses");
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <%
                ...
                ArrayList<Expenses> cashs = salesOPx.getExpenses(date);
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header text-center">Fund Expenses - <%=new SimpleDateFormat("yyyy-MM-dd").format(OdicUtil.convertJavaSqlDateToNormalDate(date))%></h1>                          
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                                                ...
                                                <%if(cash.getPostedStatus().equals("notposted")){
                                                    %>
                                                     <form name="voidinvoiceform" method="post" action="transactvoidaction.jsp" >
                                                        <td class="center"><button type="submit" class="btn btn-primary" name="voidfundexpenses" value="<%=cash.getId() %>"> Void Fund Expenses</button></td>
