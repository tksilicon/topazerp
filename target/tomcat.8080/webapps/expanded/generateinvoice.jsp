        ...
        <div class="container">
            ...
            <div class="row" >
                ...
                <form method="post" action="dayinvoices.jsp" >  
                    <center style="margin-top:5px;margin-left: 100px;float: left"> <button   type="submit" name="printinvoice" class="btn btn-default" onclick="window.print(); window.print(); window.print();window.print();" >Print Admin/Cashier Copy</button> 
                ...
                <form method="post" action="printinvoice.jsp" >  
                    <center style="margin-top:5px;margin-left: 100px;float: left"> <button   type="submit" name="printinvoice" class="btn btn-default" onclick="window.print();" >Print Customer Invoice</button> 
                ...
                <form method="post" action="odicsales.jsp" >
                    <center style="margin-top:5px; margin-left: 300px;float:none"> <button   type="submit" name="cancelTxn" class="btn btn-default"  value="<%=sale.getInvoiceNo()%>">Cancel Invoice</button> 
                    </center>
                </form>
            </div>
            ...
            <div class="containter">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-5 col-xs-offset-2 text-right">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4> <%=sale.getInvoiceType() + "   Invoice"%> </h4>
                                <% if (request.getParameter("copy") != null) {
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <% if (request.getParameter("copy") != null) {
                                    ...
                                    if (sale.getTotalShadow() > 0) {
                            %>
                            <td class="text-right"><%= f.format(prod.getTotalShadowPrice())%></td>
                            <%                                }
                            ...
                            <td class="text-right"><%= f.format(prod.getSubTotalAfterShadow())%></td>
                ...
                <div class="row text-right">
                    ...
                    <div class="col-xs-2">
                        <strong>
                            ...
                            <% if (request.getParameter("copy") != null) {
                                    ...
                                    if (sale.getTotalShadow() > 0) {
                            %>
                            <%= f.format(sale.getTotalAfterShadowDiscount())%>
                            <%
                            } else {
                    ...
                    <div class="col-xs-2">
                        <strong>
                            ...
                            <% if (request.getParameter("copy") != null) {
                                    ...
                                    if (sale.getTotalShadow() > 0) {
                            %>
                            <%= f.format(sale.getTotalAfterShadowDiscount())%><br>
                            &#8358; <%=   f.format(sale.getTotalAfterDiscount())%> 
                            <%
                            } else {
                    ...
                    <div class="col-xs-2">
                        <strong>
                            ...
                            %>
                            <%=  f.format(sale.getBalanceForShadow())%>
                ...
                <div class="row text-left">
                    <div class="col-xs-6">
                        ...
                        <label class="label-info">THANKS FOR YOUR PATRONAGE</label> <br>
                ...
                <div class="row text-left">
                    <div class="col-xs-12">
                          ...
                          <%
                           ...
                           String phrase = "";
                            ...
                            if (request.getParameter("copy") != null) {
                                ...
                                phrase = String.valueOf(sale.getTotal()); 
                               
                               
                               
                           }else{
                               
                                 phrase = String.valueOf(sale.getTotalAfterShadowDiscount());  
                           }
                        ...
                        <p> <h5>Amount in Words</h5> <h3> <%= s%></h3></p>
                    </div>
                </div>
                <br>
                ...
                <div class="row text-left" >
                    <div class="col-xs-6">
                        ...
                        <p class="text-right">Customer's Signature</p>
                    </div>
