        ...
        <table align="center" bgcolor="white" width="1205" height="500" frame="border">
            ...
            <td>
                ...
                <div align="right"    style=" overflow-y: scroll;  border:  scrollbar; width: 1190px; height: 480px;" >
                    ...
                    <jsp:include page="selectgarmsort.jsp"></jsp:include>
                    ...
                    <table height="10">
                        ...
                        <tr valign="center" bgcolor="#333366" align="center" height="30">
                            ...
                            <TD align="center"><FONT FACE="tahoma" SIZE="2" color="blue"><B>Year</B></FONT></TD>
                        ...
                        <%
                            ...
                            String dat = "";
                            try {
                                if (request.getParameter("gyear") != null) {
                                    ...
                                    String sql = "select  * from initialinsp where year = '" + kw + "'";
                                    String sql1 = "select count(*) from initialinsp where year = '" + kw + "' AND itemtype = 'Suits'  ";
                                    String sql2 = "select count(*) from initialinsp where year = '" + kw + "' AND itemtype = 'Shirts'";
                                    String sql3 = "select count(*) from initialinsp where year = '" + kw + "' AND itemtype ='Natives'";
                                    String sql4 = "select count(*) from initialinsp where year = '" + kw + "' AND itemtype ='Casuals'";
                                    String sql5 = "select count(*) from initialinsp where year = '" + kw + "' AND itemtype ='Beddings'";

                                    String sql6 = "select count(*) from initialinsp where year = '" + kw + "' AND itemtype ='Curtains'";
                                    String sql7 = "select count(*) from initialinsp where year = '" + kw + "' AND indexcode ='D'";
                                    String sql8 = "select count(*) from initialinsp where year = '" + kw + "' AND indexcode ='L'";
                                    String sql9 = "select count(*) from initialinsp where year = '" + kw + "' AND indexcode ='P'";
                        %>
                        ...
                        <tr bgcolor="#eeeeee">
                            ...
                            <td align="center"><FONT FACE="tahoma" SIZE="2" color="gray"><%=set7.getString("year")%></FONT></td>
