        ...
        <form action="insert.jsp" method="post" onsubmit="MM_validateForm('id', '', 'R', 'name', '', 'R', 'pic', '', 'RisNum', 'price', '', 'RisNum');
            ...
            <table align="center" frame="border" bgcolor="#eeeeee" width="700" height="180" style="background-image:  url(images/back.gif);">
                ...
                <tr>
                    ...
                    <td ><input type="text" name="ddate" value="<%= session.getAttribute("sqldate")%>" size="30"></td>
                ...
                <tr>
                    ...
                    <td> <select name="pic" id="my_input1"   width="5" >
                            <option >   1   </option>
                            <option>   2     </option>
                            <option>   3    </option>
                            <option>   4    </option>
                ...
                <tr>
                    ...
                    <td ><font color="#333399" size="3">Branch C Price: </font> </td>
            ...
            <table align="center" frame="border" bgcolor="#663399" width="700" height="45">
                ...
                <tr align ="left">
                    ...
                    <td align ="left"><input type="button" value="Update Items" size="20"   style="background-color:red;font-weight:bold;color:#ffffff;" /></td>
                    <td align ="left"><input type="button" name="delitem" value="Delete Item" size="20"   style="background-color:red;font-weight:bold;color:#ffffff;" /></td>
                    <td align ="left"><a href="regccextra.jsp"><input type="button" value="Extra Charge" size="20"  style="background-color:red;font-weight:bold;color:#ffffff;" /></a></td>
                </tr>
            </table>
        </form>
