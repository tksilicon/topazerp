<%-- 
    Document   : allexpenses
    Created on : Dec 16, 2014, 9:06:55 PM
    Author     : THANKGOD
--%>
            ...
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <%
                        ...
                        ArrayList expenses = salesOpx.getExpenses();
                    ...
                    <div class="row">
                        <div class="form-group">                           
                            <a href="expenses.jsp" role="button" class="col-xs-2 btn btn-success btn-large">New Expenses</a>                            
                        </div>
                    </div>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <%
                                            ...
                                            Iterator itil = expenses.iterator();
                                            Expenses expense = null;

                                            int counter = 1;

                                            while (itil.hasNext()) {
                                                expense = (Expenses) itil.next();

                                        %>                                   

                                        <tr>
                                            <td><%=counter%></td> 
                                            <td><%=expense.getPurpose() %></td> 
                                            <td><%=expense.getExpenseType() %></td>                                    
                                            <td><%= expense.getAmount() %></td>  
                                            <td><%= expense.getBalance() %></td> 
                    ...
                    <div class="row">
                        <div class="form-group">                           
                            <a href="print/printexpenses.jsp" role="button" class="col-xs-2 btn btn-success btn-large">Print</a>                           
                        </div>
                    </div>
