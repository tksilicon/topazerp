    ...
    <body>
        ...
        <table align="center" frame="border" bgcolor="#333399" width="741" height="30" style="background-image:  url(images/acct1.gif);">
            ...
            <tr align="center">
                ...
                <td align="center"><font size="4" color="white"><b>PAYMENT FOR PURCHASE (VENDOR) </b></font>  </td>
        ...
        <form action="insert.jsp" method="post" onsubmit="MM_validateForm('vendor','','R','date','','R','amount','','R','phone','','RisNum','email','','RisEmail', 'admin','','R' , 'bal','','R');return document.MM_returnValue">
            ...
            <table align="center" frame="border" bgcolor="#eeeeee" width="741" height="310" style="background-image:  url(images/back.gif);">
                ...
                <tr>
                    ...
                    <td ><font color="#333399" size="3">Vendor: </font> </td>
                     <td> <select  name="newvendor" width="30" onchange="showEmp2(this.value);">
                              <option value="-1">Select a vendor</option>
                    <%
                               // HashMap l = new HashMap();
                               // HashMap hm = new HashMap();
                                // OurMap hm = new OurMap();
                                String name = "";
                                try {
                                    ...
                                    String sql = "select * from purchase where balance > 0 ";

                                    ResultSet rss = st.executeQuery(sql);

                                    while (rss.next()) {

                                       // l.put(rss.getString("vendor"), rss.getString("vendor"));
                                       // l.put(rss.getString("vendor"), rss.getString("vendor"));
                                        //l.put(rss.getInt("id"), rss.getInt("id"));
                    ...
                    %>
                            ...
                            %>
                            <option value="<%= rss.getString("id") %>">  <%= rss.getString("vendor")%> </option>
                ...
                <tr>
                    ...
                    <td ><input type="text" name="address" value="null"  size="30"> </td>
                ...
                <tr>
                    ...
                    <td ><font color="#333399" size="3">Inventory Account </font> </td>
                    <%
                                ...
                                try {
                                    ...
                                    String sql = "select * from account where accounttype = 'inventory' ";
            ...
            <table align="center" frame="border" bgcolor="#663399" width="741" height="45">
                ...
                <tr align ="left">
                    <td align ="left"><input type="submit" value="Pay Vendor" name="payment2" size="20"  style="background-color:red;font-weight:bold;color:#ffffff;" /></td>
