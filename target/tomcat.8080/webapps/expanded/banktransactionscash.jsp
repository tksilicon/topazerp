<%-- 
    Document   : banktransactions
    Created on : Dec 15, 2014, 12:48:02 PM
    Author     : THANKGOD
--%>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <form name="purchaseForm" method="post" action="selectdate.jsp" method="post" onsubmit="MM_validateForm('amountpaidin','','R', 'bankpayed', '', 'R','tellerno', '','R', 'paymentdate', '','R' ); return document.MM_returnValue" >
                                ...
                                <div class="panel panel-info">
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-xs-3   text-right">Amount</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-offset-4">
                                                <select  class="form-control" name="bankpayed" />  
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-xs-3   text-right">Teller No</label>
                                            <div class="col-md-offset-4">
                                                <input class="form-control"  name="tellerno" />
                                            </div>
                                        </div>
