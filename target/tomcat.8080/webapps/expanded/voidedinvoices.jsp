...
<%
    ...
    if (username != null) {
        ...
        voidedInvoicex = manOpx.getVoidedInvoices(staff.getBranch());

        session.setAttribute("voidedInvoicex", voidedInvoicex);
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example2">
                                        ...
                                        <tbody>
                                            <%
                                                ...
                                                int counter = 0;
                                                VoidedInvoices prod = null;

                                                Iterator itil = voidedInvoicex.iterator();

                                                while (itil.hasNext()) {

                                                    prod = (VoidedInvoices) itil.next();
                                                    counter++;
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="left"> <%= prod.getInvoiceno() %></td>
                                                <td class="left"> <%= new SimpleDateFormat("yyyy-MM-dd").format(prod.getDateInvoice()) %></td>
                                                

                                                <td class="center"> <%= prod.getStaffName() %></td>
