<%-- 
    Document   : report
    Created on : Dec 20, 2014, 3:02:54 PM
    Author     : THANKGOD
--%>
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <li class="active">
                            <a href="#"><i class="fa fa-fw fa-file"></i> Reports</a>
                        </li>
                    </ul>
                </div>
                                ...
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div class="huge"></div>
                                            <div>Todays Report</div>
                                        </div>
                                    </div>
                                </div>
                                <a href="checklastreport.jsp">
                            ...
                            <div class="panel panel-yellow">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div class="huge"></div>
                                            <div>Receipts/Cash</div>
                                             <div>FundExpenses/BankTrs</div>
                                        </div>
                                    </div>
                                </div>
                                <a href="selectreceieptcash.jsp">
                                    <div class="panel-footer">
                                        <span class="pull-left">New</span>
                                        <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                        <div class="clearfix"></div>
                            ...
                            <div class="panel panel-yellow">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div class="huge"></div>
                                            <div>Periodical Report</div>
                                        </div>
                                    </div>
                                </div>
                                <a href="selectdateperiod.jsp">
                                    <div class="panel-footer">
                                        <span class="pull-left">New</span>
                                        <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                        <div class="clearfix"></div>
