...
session.setAttribute("pageinfo2", "Expenses Archive ");
%>
...
<html>
    ...
    <body>
        ...
        <table align="center" bgcolor="white" width="1205" height="400" frame="border">
            ...
            <td align="right" width="300" valign="top"><div align="center"   style=" overflow-y: scroll;  height: 500px;" > <jsp:include page="selectarchive.jsp" flush="true" ></jsp:include>  <jsp:include page="selectexpesearch.jsp" flush="true" ></jsp:include> </div> </td>
            <%--
