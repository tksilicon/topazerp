...
// response.sendRedirect("mdaccess.jsp");
// }
session.setAttribute("pageinfo2", "Staff Records");
%>
...
<html>
    ...
    <body>
        ...
        <table align="center" bgcolor="white" width="1205" height="400" frame="border">
            ...
            <td align="right" width="210"  valign="top"> <div align="center"   style=" overflow-y: scroll;  height: 600px;" >  <jsp:include page="selectstaff.jsp" flush="true" ></jsp:include> </div> </td>
