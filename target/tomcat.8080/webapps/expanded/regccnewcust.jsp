...
session.setAttribute("pageinfo", "New Customers Registration Form");
%>
<%-- 
    Document   : welcome
...
<html>
 ...
 <jsp:include flush="true" page="cshead.jsp"></jsp:include>
    ...
    <table align="center" bgcolor="white" width="1205" height="500" frame="border">
        ...
        <td align="right" valign="top">  <jsp:include page="newcustomer.jsp" flush="false"></jsp:include></td>
