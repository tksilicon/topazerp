        ...
        <table align="center" class="rowHover"   frame="border"  id="customer" width="940"  cellspacing="1">
            ...
            <%
                ...
                try {
                    ...
                    String sql = "select * from depositarch";
            ...
            <tr bgcolor="#eeeeee">
                ...
                <TD align="center"><FONT FACE="tahoma" SIZE="2" color="gray"><%= set.getString("tellerno")%></FONT></TD>
               
                <TD align="left"><FONT FACE="tahoma" SIZE="2" color="gray"><%=set.getString("depositor")%></FONT></TD>
