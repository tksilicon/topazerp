...
if(session.getAttribute("username") == null){
 ...
 session.setAttribute("pageinfo2", "Edit Comment");
%>
<%-- 
    Document   : welcome
...
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
         <link rel="icon"  type="image/gif" href="echelon2.gif">
        <title>Comment</title>
    </head>
    <body>
        ...
        <table align="center" bgcolor="white" width="1205" height="400" frame="border">
            ...
            <td align="center" valign="top"> <jsp:include page="insertcomment.jsp" flush="true"></jsp:include></td>
