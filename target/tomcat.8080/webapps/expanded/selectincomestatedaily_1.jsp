    ...
    <body>
        ...
        <%
                    ...
                    try {
                        ...
                        ResultSet rs = st.executeQuery("SELECT  DAY(getDate()-30), MONTH(getDate()-30), YEAR(getDate()-30) from extrainfo ");
                    ...
                    session.setAttribute("onlydate", rd + "-" + rd1 + "-" + rd2);
                    String incdate = rd + "-" + rd1 + "-" + rd2;
            ...
            <%
                        ...
                        if (request.getParameter("incomenameyear") != null) {
                            ...
                            try {
                                ...
                                String sql = "SELECT branch, Date, custname,  invoiceid, amtpaid, staff, '" + type2 + "' from ourinvoice where amtpaid >0 AND custtype ='regular' AND year ='" + year + "'  UNION ALL SELECT branch, Date, custname, invoiceid, amtpaid, staff, '" + type1 + "'  from pickup where amtpaid > 0 AND custtype ='regular' AND year ='" + year + "' ";
        ...
        <tr align="left" width="100">
            <td>
                <%
                                               ...
                                               double total1 = bal.totalincome11(year);
                                               double total2 = bal.totalincome22(year);
                                               double total3 = bal.totalincome33(year);
                                               double gtotal = total1 + total2;
                                               double gtotal2 = gtotal + total3;

                %>

                <font color="blue" face="tohoma" size="4"> Total Income for the Year <%= year%>  = &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;  N<%out.print(formatter.format(gtotal));%>.00</font>
        </tr>
        <tr>
            <td>
                <font color="blue" face="tohoma" size="4">Amount Paid by Package Customers =&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; <u>N<%out.print(formatter.format(total3));%>.00 </u></font>
            </td>
        </tr>
        <tr>
            <td>
                <font color="blue" face="tohoma" size="4">Total Yearly Income   = &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;  <u><span style="border-bottom: 1px double #000;"><b> N<%out.print(formatter.format(gtotal2));%>.00</b> </span> </u> (Cash Received)</font>
            </td>
        </tr>
    </table>
    <%
